...
const Navbar = () => {
  ...
  const menuItems = [
    { name: "home.label", path: "/home" },
    {
      name: "tentangKami.pageTitle", path: "/tentang-kami",
      subMenu: [
        { name: "profil.title", path: "/tentang-kami/profil" },
        { name: "visiMisi.title", path: "/tentang-kami/visi-misi" },
        { name: "nilaiPendekatan.title", path: "/tentang-kami/nilai-pendekatan" },
        { name: "timPakar.title", path: "/tentang-kami/tim-pakar" },
        { name: "struktur.judul", path: "/tentang-kami/struktur" },
        { name: "legalitas.title", path: "/tentang-kami/legalitas" },
      ],
    },
    {
      name: "isuPrioritas.title", path: "/isu-prioritas",
      subMenu: [
        { name: "perubahanIklim.title", path: "/isu-prioritas/perubahan-iklim" },
        { name: "gambut.title", path: "/isu-prioritas/gambut" },
        { name: "mangrove.title", path: "/isu-prioritas/mangrove" },
        { name: "energi.title", path: "/isu-prioritas/energi" },
        { name: "konflikAgraria.title", path: "/isu-prioritas/konflik-agraria" },
        { name: "sampah.title", path: "/isu-prioritas/sampah" },
        { name: "ekonomiHijau.title", path: "/isu-prioritas/ekonomi-hijau" },
        { name: "ketahananPangan.title", path: "/isu-prioritas/ketahanan-pangan" },
      ],
    },
    {
      name: "programKerja.title", path: "/program-kerja",
      subMenu: [
        { name: "researchDevelopment.title", path: "/program-kerja/research-development" },
        { name: "communityEmpowerment.title", path: "/program-kerja/community-empowerment" },
        { name: "ecologicalConflict.title", path: "/program-kerja/ecological-conflict-resolution" },
        { name: "environmentalEducation.title", path: "/program-kerja/environmental-education" },
        { name: "riauSocioEco.title", path: "/program-kerja/riau-socio-eco" },
      ],
    },
    { name: "insight.title", path: "/insight" },
    {
      name: "publikasiRiset.title", path: "/publikasi-riset",
      subMenu: [
        { name: "artikelIlmiah.title", path: "/publikasi-riset/artikel-ilmiah" },
        { name: "policyBrief.title", path: "/publikasi-riset/policy-brief" },
        { name: "laporanPenelitian.title", path: "/publikasi-riset/laporan-penelitian" },
        { name: "buku.pageTitle", path: "/publikasi-riset/buku" },
        { name: "infografisData.title", path: "/publikasi-riset/infografis" },
      ],
    },
    { name: "kegiatan.title", path: "/kegiatan" },
    { name: "dampak.title", path: "/dampak" },
    { name: "mitra.title", path: "/mitra" },
  ];
