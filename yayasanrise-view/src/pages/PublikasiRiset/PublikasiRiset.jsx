...
const PublikasiRiset = () => {
  ...
  const kategori = [
    {
      title: t("publikasiRiset.kategori.artikelIlmiah.title"),
      badge: "Artikel",
      desc: t("publikasiRiset.kategori.artikelIlmiah.desc"),
      path: "/publikasi-riset/artikel-ilmiah",
    },
    {
      title: t("publikasiRiset.kategori.policyBrief.title"),
      badge: "Policy",
      desc: t("publikasiRiset.kategori.policyBrief.desc"),
      path: "/publikasi-riset/policy-brief",
    },
    {
      title: t("publikasiRiset.kategori.laporanPenelitian.title"),
      badge: "Laporan",
      desc: t("publikasiRiset.kategori.laporanPenelitian.desc"),
      path: "/publikasi-riset/laporan-penelitian",
    },
    {
      title: t("publikasiRiset.kategori.bukuModul.title"),
      badge: "Buku",
      desc: t("publikasiRiset.kategori.bukuModul.desc"),
      path: "/publikasi-riset/buku",
    },
    {
      title: t("publikasiRiset.kategori.infografisData.title"),
      badge: "Infografis",
      desc: t("publikasiRiset.kategori.infografisData.desc"),
            ...
            {kategori.map((item, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-end mt-6 text-[#4A7C44] opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300">
                  <span className="text-xs font-medium mr-1.5">{t('publikasiRiset.lihatDetail')}</span>
